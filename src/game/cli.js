...
var commands = {
    ...
    'spawn': function(amtStr, objStr) {
        ...
        if (!objects[objStr]) {
            objStr = utils.capitalize(objStr.toLowerCase());
        }
...
var defaults = function(objStr) {
    ...
    return {
        ...
        'Bubble': [
            ['armor', 'x', 'y', 'angle'],
            [0, utils.randomRange(32, gfx.width-32), utils.randomRange(-320, -32), Math.random() * 360]
        ],
        'WarriorBubble': [
            ['armor', 'x', 'y', 'angle'],
            [0, utils.randomRange(32, gfx.width-32), utils.randomRange(-320, -32), Math.random() * 360]
...
export default function CLI(commandWithArgs, context, noCall) {
